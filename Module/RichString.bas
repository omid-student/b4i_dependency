...
Public Sub Alignment(Align As Int)
	Dim no As NativeObject
	no = no.Initialize("NSMutableParagraphStyle").RunMethod("new", Null)
	no.SetField("alignment", Align)
	AddAttribute("NSParagraphStyle", no, 0, t.Length)
End Sub
