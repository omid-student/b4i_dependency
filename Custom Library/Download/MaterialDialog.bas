...
Public Sub Initialize(Module As Object,Event As String) As MaterialDialog
	...
	NegativeButton.CustomLabel.Font			=	Font.CreateNewBold(14)
...
Public Sub Typeface(Medium As Font,Regular As Font) As MaterialDialog
	Medium2			=	Medium
	Regular2		=	Regular
	lblContent.Font	=	Regular
...
Public Sub Progress(ProgressColor As Int) As MaterialDialog
	...
	progress_view_title.TextAlignment	=	progress_view_title.ALIGNMENT_CENTER
...
Private Sub FitSizeContent
	...
	If InputMode Then
		p1.AddView(txtinput,5dip,lblContent.Top + lblContent.Height + 20dip,p1.Width - 10dip,40dip)
	...
	Else if CheckboxMode Then
		p1.AddView(checkbox2,5dip,lblContent.Top + lblContent.Height + 20dip,50dip,50dip)
	...
	Else if ProgressMode Then
		p1.AddView(progress_view,20dip,lblContent.Top + lblContent.Height + 40dip,p1.Width - 40dip,35dip)
		p1.AddView(progress_view_title,20dip,lblContent.Top + lblContent.Height + 17dip,p1.Width - 40dip,50dip)
		Top	=	progress_view.Top + progress_view.Height + 35dip
		
	Else if CustomViewMode Then
		p1.AddView(svCustomView,5dip,lblContent.Top + lblContent.Height + 20dip,p1.Width - 10dip,CustomViewHeight)
	...
	divider.Initialize("")
	divider.Color	=	Colors.ARGB(5,20,20,20)
	p1.AddView(divider,0,Top - NegativeButton.Height,p1.Width,1dip)
